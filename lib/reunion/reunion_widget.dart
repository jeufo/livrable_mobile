...
class ReunionWidget extends StatefulWidget {
  ...
  static String routeName = 'reunion';
  static String routePath = '/reunion';
...
class _ReunionWidgetState extends State<ReunionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReunionModel());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 0.0),
                                    child: Text(
                                      'Discutez par messages avec votre groupe',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(

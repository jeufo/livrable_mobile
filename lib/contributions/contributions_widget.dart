...
class ContributionsWidget extends StatefulWidget {
  ...
  static String routeName = 'contributions';
  static String routePath = '/contributions';
...
class _ContributionsWidgetState extends State<ContributionsWidget> {
  late ContributionsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContributionsModel());
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Contribution mensuelle: 25,000 FCFA',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Contribution mensuelle: 30,000 FCFA',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Contribution mensuelle: 20,000 FCFA',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Inter',
